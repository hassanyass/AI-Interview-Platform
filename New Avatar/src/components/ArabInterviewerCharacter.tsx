...
export type { InterviewerCharacterState } from './InterviewerCharacter'
import type { InterviewerCharacterState } from './InterviewerCharacter'

export interface ArabInterviewerCharacterProps {
 ...
 */
export default function ArabInterviewerCharacter({
  state,
  size = 'medium',
  presence = false,
  className = '',
}: ArabInterviewerCharacterProps) {
